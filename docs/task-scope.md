...
| AI-01 | ฟิล์ม | `ai/app/`, `main.py`, `database/rag/vector_repository.py`; owner-approved lazy initialization in `database/session.py`, `database/storage.py`; AI-01 unit, integration, architecture, and database tests; `docs/ai-01-runbook.md` | HTTP vector insertion and search proven by a `postgres`-marked test against an isolated database; see [runbook](ai-01-runbook.md) |
